...
Foreach ($Lib in $CertLibs.GetEnumerator())
{
    ...
    $FilesToSign.Add($MovedFile.FullName)
}
...
If (![File]::Exists($File))
{
    ...
    $Assemblies.AddRange($FilesToSign)
